...
const Landing = () => {
  return (
    <div className="bg-agsm-yellow-100 mb-65 flex lg:h-screen flex-col">
      <div className="relative w-screen overflow-hidden">
        ...
        />
        <div className="absolute -bottom-1 flex w-full justify-center text-4xl lg:text-8xl font-bold text-white">
          UCR AGSM Product Club
        </div>
      </div>

      <div className="absolute my-60 md:my-110 lg:my-180 w-full">
        <div className="text-agsm-blue-200 mt-4 flex text-center justify-center text-2xl lg:text-3xl">
