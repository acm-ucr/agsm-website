...
const Footer = () => {
  return (
    <div className="bg-agsm-blue-200 flex h-30 md:h-45 w-full">
      <div className="flex h-full w-full items-center justify-between px-30 relative">
        <div className="flex">
          <div className="hidden md:block">
            <Image src={AGSMLogo} alt="AGSM Logo" className="size-30" />
          </div>
          <div className="mt-1 ml-10 flex flex-col gap-7 text-white hidden md:block">
            <div>
        ...
        <div className="flex flex-col gap-3 md:pb-3 absolute right-3 md:relative">
