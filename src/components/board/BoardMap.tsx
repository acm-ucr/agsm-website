  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-center py-8">
      <div className="flex w-screen flex-col items-center justify-center gap-16 py-16">
        ...
        <div className="flex flex-wrap w-full flex-row justify-center gap-16">
      ...
      <div className="mx-auto grid w-full max-w-4xl grid-cols-1 md:grid-cols-2 gap-4">
<div className="flex flex-col items-center gap-2">
  <motion.div
          ...
          <div className="flex w-full flex-row justify-center gap-2 -ml-18">
